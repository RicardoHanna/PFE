...
if(isset($_POST["submit"])){
	...
	$cid=mysqli_connect("localhost","root","","employee101") or die('error connecting');
...
$mysql_qry="insert into signup(username,email,password,cpassword) values ('$username','$email','$password','$cpassword')";
